...
Purpose: Baseline market business survey data values' labeling
...
* LABELING VALUES
	...
	124 "Meat Shop" 125 "Cosmetics Shop" 126 "Milk Shop" 127 "Watch Shop" 128 "Worship Material Shop" 129 "Coal Shop" 130 "Furniture Retail" ///
	131 "Fuel Shop" 132 "Junk Dealer" 133 "Iron Rod and Sheet Retail" 199 "Others"
	...
	219 "Optician" 220 "Metal Processing" 221 "Jewellery Repair" 222 "Wood Processing" 223 "Paan/Tobacco Processing Shop" 224 "Stove Repair" ///
	225 "Mobile Repair" 226 "Grain Processing" 227 "Shoe Repair" 228 "Home Furnishing" 229 "Oil Processing" 230 "Agri/Non-agri Consultancy" 299 "Others"
	label define workshop_type 301 "Mill" 302 "Metal workshop" 303 "Wood workshop" 304 "Biscuit Factory" 305 "Soap Factory" ///
	306 "Jewellery Making" 307 "Sweets/Confectionery Production" 308 "Textile Industry" 309 "Pottery" 310 "Tobacco Manufacturing" ///
	311 "Brick Kiln" 312 "Ice Factory" 313 "Pillar Making" 399 "Others"
	label define proprietor 1 "Self-Proprietorship" 2 "Family-Proprietorship" 3 "Employee" -102 "Others"
	label define land_unit 1 "Dhoor" 2 "Kattha" 3 "Gaz" 4 "Square Feet" 5 "Hectare" 6 "Dismil" 7 "Bigha" -102 "Others"
	label define builtup_unit 1 "Dhoor" 2 "Kattha" 3 "Bigha" 4 "Square Feet" 5 "Square Meter" 6 "Acre" 7 "Hectare" 8 "Dismil" 9 "Square Yard" -102 "Others"
	...
	label define genset_shared_exp_unit 1 "Weekly" 2 "Fortnightly" 3 "Monthly" 4 "Daily" -102 "Others"
	...
	label define meter_complaint_location 1 "Energy Department/PSS" 2 "Meter Reader" 3 "Bill Collectors" 4 "Linemen" -102 "Others"
	...
	label define bill_payment_location 1 "PSS/Discom Office" 2 "RRF Centre" 3 "Someone Else Submits My Bill" 4 "Pay Online" -102 "Others"
	...
	label define owner 1 "Self-owned" 2 "Family-owned" 3 "Relative/Public Space (No Rent)" -102 "Others"
	...
	_duplicate_parent_key _duplicate_survey e5_elec_genset c*_*_have d*_*_have g25_income_rent_int yesno
