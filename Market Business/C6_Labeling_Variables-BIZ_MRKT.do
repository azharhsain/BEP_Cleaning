...
Purpose: Baseline market business survey data variables' labeling
...
* LABELING VARIABLES
	...
	label variable _market_id "Market ID"
	label variable _market_id_complete "Complete market ID"
