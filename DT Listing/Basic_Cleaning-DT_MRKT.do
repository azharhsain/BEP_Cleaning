...
Purpose: Basic cleaning of sampled market distribution transformer survey data
...
* MERGING AREA TYPE AND LOADING RAW DATA IN MEMORY
	...
	merge 1:m district pss feeder market using CUMULATIVE_DT_MRKT_16May2015
	//Dropping markets that have remained unelectrified historically
	drop if _merge==1
...
* PERFORMING BASIC CLEANING
	...
	rename marketid _market_id_complete
	...
	label variable _market_name "Market name"
...
* SAVING WORKING DATA AND CODEBOOK
	...
	cd "`WORKING_DATA'"
	save CUMULATIVE_DT_MRKT_16May2015_WORKING, replace
	log using market_dt_survey_codebook.txt, text
	codebook
	log close
